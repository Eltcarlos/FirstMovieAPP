...
import { IfMovieLiked, LikeMovie } from '../../Context/Functionalitems';
            ...
            <img 
             ...
             <div className='absolute linear-bg xl:pl-52 sm:pl-32 pl-8 top-0 bottom-0 right-0 left-0 flex flex-col justify-center lg:gap-8 md:gap-5 gap-4'>
                ...
                <div className='flex gap-5 items-center'>
                  ...
                  className='bg-subMain hover:text-main transitions text-white px-8 py-3 rounded font-medium sm:text-sm text-sm'
                  >
                    Watch Now
                  </Link>
                  <button 
       ...
       : (
        <div className={sameClass}>
          ...
          <p className='text-border text-sm'>
            It seems like we dont gave any movie
          </p>
         </div> 
       ))}
    </div>
