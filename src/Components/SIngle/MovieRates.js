      ...
      <div className='mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='xl:col-span-2 w-full flex flex-col gap-8'>
          ...
          <p className='text-sm leading-7 font-medium text-border'>
            ...
            Excepteur do laborum do consectetur exercitation pariatur est occaecat ex nostrud irure ipsum.
          </p>
          ...
          {/* Message */}
           <div className='w-full'>
              ...
              label='Message' placeholder='Make it short and sweet...'/>
              {
                errors.comment && 
         ...
         <div className='w-full flex flex-col bg-main gap-6 rounded-lg md:p-12 p-6 h-header overflow-y-scroll'>
           {
             movie?.reviews?.length > 0 ? movie?.reviews?.map((review)=>(
              <div key={review} className='md:grid flex flex-col w-full grid-cols-12 gap-6 bg-dry p-4 border border-gray-800 rounded-lg'>
