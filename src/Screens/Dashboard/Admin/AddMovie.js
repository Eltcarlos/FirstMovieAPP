    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='w-full grid md:grid-cols-2 gap-6'>
          ...
          <div className='text-sm w-full'>
            <Select label='Movie Category' options={CategoriesDate}/>
          </div>
          {/* MOVIE VIDEO */}
                    ...
                    UsersData.map((user,i)=>(
                        <div key={i} className='p-2 italic text-xs text-text rounded flex-colo bg-main border border-border'>
                           ...
                           <div className='flex-rows mt-2 w-full gap-2'>
                            <button className='w-6 bg-dry  flex-colo border border-border text-subMain rounded'>
                                <MdDelete/>
                            </button>
                            <button onClick={() => 
                               { setCast(user);
                                setModalOpen(true)}} className='w-6 bg-dry  flex-colo border border-border text-green-600 rounded'>
                                <FaEdit/>
                            </button>
                           </div>
                        </div>
