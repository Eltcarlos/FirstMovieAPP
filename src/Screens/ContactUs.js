    ...
    const ContactData = [
        {
            ...
            icon: FiMail,
            contact: 'info@carlos.com',
        },
        {
            id:2,
            title: 'Call Us',
            info: 'minim exercitation id aute amet et commodo minim anim.',
            icon: FiPhoneCall,
            contact: '+434 334 3439',
        },
        {
            id:3,
            title: 'Location',
            info: 'Dar es salaam, Tanzania. 345 Kigndom, street 23 45b',
            icon: FiMapPin,
            contact: ''
        }
    ]
